...
const Contact = () => {
  ...
  const validateForm = () => {
    ...
    required.forEach(
      (form) =>
        !formData[form].trim() && (newErrors[form] = "Fill this field."),
    );
  ...
  return (
    <section
      id="contact"
      className="w-full min-h-screen relative bg-black overflow-hidden text-white py-20 px-6 md:px-20 flex flex-col md:flex-row gap-10 items-center"
    >
      <ParticlesBackground />
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-center gap-10">
        ...
        {/* Rightside */}
        <motion.div
          className="w-full md:w-1/2 bg-white/5 p-4 rounded-2xl shadow-lg border border-white/10"
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <option value="UI Development" className="text-black">
                  UI Development
                </option>
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                value={formData.idea}
                onChange={handleChange}
                className={`p-2 rounded-md bg-white/10 border ${errors.idea ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}
              ></textarea>
              {errors.idea && (
            ...
            <motion.button
              className="bg-blue-500 hover:bg=blue-700 disabled:opacity-60 text-white py-3 rounded-md font-semibold transition"
